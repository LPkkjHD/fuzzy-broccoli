...
pub const SPRITE_SHEET_PATH: &str = "zombie_apocalypse_tileset/zombie_apocalypse_tileset_reference.png";
pub const SPRITE_PADDING_X: f32 = 1.0;
pub const SPRITE_PADDING_Y: f32 = 3.0;
